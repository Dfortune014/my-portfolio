...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
        ...
        bg-white  dark:bg-grid-white/[0.003] bg-grid-black/[0.2]
    ...
    justify-center'>
      ...
      words='Empowering Innovation with Reliable Scalable, and Automated Solutions'
      />

      <p className='text-center md:tracking-wider mb-4 text-sm
      md:text-lg lg:text-2xl'>
        Hi, I&apos;m Fortune Linus, a DevOps, SRE and Cloud Engineer passionate about automating cloud infrastructures.
      </p>
